...
// the below function is important for implementation of build tree
...
// the below function will recursively build the tree using inorder and preorder traversal
